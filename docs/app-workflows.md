...
- Picks finite parameters from selectors — task (preset list), cameras (1–3),
  frames (30/60/120), fps (10/30), resolution (128/256). Safe defaults are shown
  as guidance (no autofill button).
- Submits → backend builds a genuine LeRobot v3 dataset locally (device auto
