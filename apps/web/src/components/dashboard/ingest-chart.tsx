...
export function IngestChart() {
  const { data: activity, error, refetch } = useIngestActivity(7);
  ...
  const total = data.reduce((sum, d) => sum + d.episodes, 0);
      ...
      <CardContent className="p-5">
        {error ? (
          ...
          <EmptyState
            ...
            description="Record an episode to see ingest trends here."
          />
        ) : (
